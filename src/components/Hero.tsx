...
function Hero() {
  return (
    <section className=" bg-black rounded-b-[5rem] overflow-hidden shadow-2xl ">
      <div className="max-w-7xl relative m-auto h-[110vh] w-full flex flex-col-reverse md:flex-row bg-black max-md:pb-10">
        <div className="ma md:w-[40%] h-[20%] md:h-full flex flex-col justify-center p-10">
